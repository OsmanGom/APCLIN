...
export default function Ficapacidades(props){
    ...
    const form =()=>{
        ...
        if(formu.status_p.value === ''){
          ...
          formu.time_p.className = classSuccess;
        }
    ...
    const SaveDataic=(formu)=>{
      let condition, time_p, days_p, diagnostic
      
      if(formu.condition.value === ''){
        condition = null
      }else{condition = formu.condition.value}

      if(formu.time_p.value === ''){
        time_p = ''
      }else{ time_p = formu.time_p.value}

      if(formu.days_p.value === ''){
        
        days_p = 0
      }else{
        days_p = parseInt(formu.days_p.value) 
      }
      ...
      $.ajax({
          ...
          success: function (res){
              ...
              formu.time_p.className = classnormal
                        ...
                        <div className="row">
                            <div class="form-group col-md-4" id="fecha">
                              ...
                              <div class="input-group date" >
                                <input type="time" class="form-control form-control-border" name="time_p"/>
                              </div>
                            </div>
                            <div class="form-group col-md-2">
                              <label>&nbsp;</label>
                                <input type="text" name="days_p" class="form-control form-control-border" id="exampleInputPassword1" placeholder="Dias"/>
                                <div class="invalid-feedback">
                                  Campo vacio.
                                </div>
                            </div>
