  ...
  document.querySelector('title').textContent = 'Clinica | Detalle Incapacidad';
    ...
    const Report_Incapacidades_Mensual=()=>{
      ...
      if(data.f_i.value === '' || data.f_s.value === ''){
        ...
        window.open(`http://sjysrv02/ReportServer/Pages/ReportViewer.aspx?%2fAPCLIN_REPORT%2fReportePermisoEIncapacidadesMensuales&rs:Command=Render&rs:embed=true&rc:Parameters=false&fechaer=${data.f_i.value}&fechasr=${data.f_s.value}&id_enterprise=${cookies.get('enterprise')}`,'_blank');
        data.f_i.value = ''
        data.f_s.value = ''
      }
    ...
    const Report_Incapacidades_Diario=()=>{
      ...
      if(data2.f_i2.value === '' || data2.f_s2.value === ''){
        ...
        window.open(`http://sjysrv02/ReportServer/Pages/ReportViewer.aspx?%2fAPCLIN_REPORT%2fReportePermisoIncapacidadesDiarias&rs:Command=Render&rs:embed=true&rc:Parameters=false&fechaer=${data2.f_i2.value}&fechasr=${data2.f_s2.value}&id_enterprise=${cookies.get('enterprise')}`,'_blank');
        data2.f_i2.value = ''
        data2.f_s2.value = ''
      }
    }
